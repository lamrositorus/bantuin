...
import { FaUser , FaPhone, FaEnvelope, FaLock, FaHome, FaTransgender } from 'react-icons/fa'; // Mengimpor ikon dari react-icons
...
export const Signup = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true); // Set loading menjadi true sebelum memulai pendaftaran
