                ...
                {isEditing ? (
                    <div>
                        <input
                            ...
                            onBlur={handleBlur}
                            className={`w-full bg-white p-3 rounded-xl border ${error ? 'border-red-500' : 'border-gray-200'} focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all duration-200`}
                        />
            ...
            <div className="bg-white shadow-2xl rounded-2xl p-8 backdrop-blur-sm">
                ...
                <div className="mt-10">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <EditableField label="Phone Number" field="phone_number" value={profile.phone_number} error={errors?.phone_number} />
                        <EditableField label="Address" field="address" value={profile.address} error={errors?.address} />
                        <EditableField label="Gender" field="gender" value={profile.gender} error={errors?.gender} />
                    </div>
                </div>
            </div>
        </div>
